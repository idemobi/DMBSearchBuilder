...
public sealed class SearchModelTests
{
    ...
    {
        SearchViewerOptions options = new();
    ...
    public void ResponseAndPageViewModelKeepMutableResultAndErrorCollections()
    {
        ...
        SearchPageViewModel model = new() { Term = "search", IsDemo = true };

        response.Results.Add(new SearchResult { Title = "Result", Score = 42 });
        response.Errors.Add(new SearchProviderError { ProviderName = "Provider", Message = "Unavailable" });
