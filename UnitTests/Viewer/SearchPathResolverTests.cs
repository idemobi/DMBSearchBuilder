...
[TestFixture]
public sealed class SearchPathResolverTests
{
    [Test]
    public void ResolveCombinesRelativePathWithContentRoot()
    {
        ...
        string resolved = SearchPathResolver.Resolve(environment, "Search/data.db");
    ...
    public void ResolveKeepsAbsolutePath()
    {
        ...
        string resolved = SearchPathResolver.Resolve(environment, absolutePath);
