...
using BuilderNormalizer = DMBSearchBuilder.SearchTextNormalizer;
using CoreNormalizer = DMBSearchCore.SearchTextNormalizer;
...
[TestFixture]
public sealed class SearchTextNormalizerAlignmentTests
{
    [Test]
