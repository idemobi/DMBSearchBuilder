...
[TestFixture]
public sealed class SearchKeywordExtractorTests
{
    [Test]
    public void ExtractKeywordsAsStringDecodesHtmlAndKeepsUniqueNormalizedTokens()
    {
        string keywords = SearchKeywordExtractor.ExtractKeywordsAsString("Caf&eacute; search search URLParser &amp; C#");
    ...
    public void ExtractPageFallsBackToVisibleTextWhenDescriptionIsMissing()
    {
        ...
        SearchPageRecord record = SearchKeywordExtractor.ExtractPage("https://example.com/fallback", html);
    ...
    public void ExtractPageReadsMetadataVisibleTextAndWeightedTerms()
    {
        ...
        SearchPageRecord record = SearchKeywordExtractor.ExtractPage("https://example.com/search-url-parser", html);
