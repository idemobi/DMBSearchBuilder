...
[TestFixture]
public sealed class SearchDatabaseManagerTests
{
    ...
    public void ClearPagesRemovesPagesAndTerms()
    {
        ...
        try
        {
            ...
            SearchDatabaseManager.SavePage(databasePath, record);
            SearchDatabaseManager.ClearPages(databasePath);
    ...
    public void EnsureTableCreatedCreatesExpectedTables()
    {
        ...
        try
        {
            SearchDatabaseManager.EnsureTableCreated(databasePath);
    ...
    public void SavePageInsertsAndUpdatesSinglePageWithWeightedTerms()
    {
        ...
        try
        {
            SearchPageRecord firstRecord = new()
            {
            ...
            SearchDatabaseManager.SavePage(databasePath, firstRecord);

            SearchPageRecord updatedRecord = new()
            {
                Url = "https://example.com/search",
            ...
            SearchDatabaseManager.SavePage(databasePath, updatedRecord);
