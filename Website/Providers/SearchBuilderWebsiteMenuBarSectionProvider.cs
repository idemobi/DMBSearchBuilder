...
internal sealed class SearchBuilderWebsiteMenuBarSectionProvider : IMenuBarSectionProvider
{
    ...
    public MenuBarModuleResult Build(TextWriter writer, IHtmlHelper html)
    {
        ...
        result.ActionList.Add(SearchBuilderLabsNavigationAgent.CreateMenuGroup());
