...
internal sealed class DMBSearchBuilderWebsiteMenuBarSectionProvider : IMenuBarSectionProvider
{
    ...
    public MenuBarModuleResult Build(TextWriter writer, IHtmlHelper html)
    {
        ...
        result.ActionList.Add(DMBSearchBuilderLabsNavigationAgent.CreateMenuGroup());
