...
{
    /// <summary>
    ///     Manages the SQLite schema and writes generated page records for <see cref="SearchBuilderAgent" />.
    /// </summary>
    public static class SearchDatabaseManager
    {
        ...
        public static void SavePage(string databasePath, SearchPageRecord record)
        {
            EnsureTableCreated(databasePath);
