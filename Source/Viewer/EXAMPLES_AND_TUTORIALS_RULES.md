# DMBSearchViewer Examples and Tutorials Rules

## Objective

Define how example pages, demo pages, information pages, concept pages, instruction pages, and tutorials are created for `DMBSearchViewer`.
...
- Default documentation area: `SearchViewer`
...
- Default DocumentationViewer package id for this project: `DMBSearchViewer`
- Default DocumentationViewer namespace for this project: `DMBSearchViewer`
...
Use this format for package introductions, architecture pages, provider-flow pages, request-flow pages, getting started pages, integration guides, and tutorials that are not focused on one visual component.
...
- may include diagrams or structured lists when they clarify provider or request flow,
- should avoid long inline API listings that belong in DocumentationViewer.

## Component or feature page format

Use this format for pages dedicated to the navbar search component, search result page, provider integration, or a tightly scoped feature family.

Required structure:

1. Title.
2. Short explanation of the feature.
3. DocumentationViewer button linking to the relevant API documentation.
4. Examples rendered with `@await Html.RenderExamplePartialAsync(...)` when copyable examples are useful.
5. Showcase or matrix covering normal, empty, error, and realistic data states when a visual feature is involved.
...
- stay focused on SearchViewer concepts such as configuration, providers, queries, result models, and navbar integration.
...
- link to relevant SearchBuilder, SearchViewer, or DocumentationViewer pages.
...
- visual search UI examples cover normal, empty, error, and realistic data states,
